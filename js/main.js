...
//    const existe = miCarrito.some((acc, el) => acc + el.id === `${producto.id}`);
//    document.getElementById('card-compra').innerHTML = `${existe}`;
///    if (existe) {
//        //Actualizamos la cantidad
//        const cantidad = miCarrito.map((el) => {
//            if (el.id === `${producto.id}`) {
//                el.cantidad++;
//                return el; // retorna objeto actualizado
///            } else {
///                return el; // retorna los objetos que no son duplicados
//           }
//        });
//        miCarrito = [...cantidad];
//   } else {
        //Agregar elementos al arreglo del carrito
        miCarrito = [...miCarrito, el];
//    }
//    
//})
